...
describe('Validator - Rule - Date', () => {
  const today = new Date('2000-12-30T00:00:00')
  ...
  const tests = [
    ...
    // Future start
    {value: new Date('2000-12-31T00:00:00'), start: 1, end: undefined, expected: true},
    // Past end
    {value: new Date('2000-12-29T00:00:00'), start: undefined, end: -1, expected: true},
    // Specific past<->today
    {value: today, start: '2000-12-29', end: 0, expected: true},
    {
      value: today,
      start: new Date('2000-12-29T00:00:00'), end: 0,
      expected: true
    },
    ...
    {
      value: today,
      start: 0, end: new Date('2000-12-31T00:00:00'),
      expected: true
    },
    // Today<->+3days
    {
      value: new Date('2001-01-01T00:00:00'),
      start: 0, end: '3d',
      expected: true
    },
    // Today<->+1week
    ...
    // Future start
    {
      value: new Date('2001-01-05T00:00:00'),
      start: '3d', end: undefined,
      expected: true
    },
    // Future<->+3days
    {
      value: new Date('2000-12-31T00:00:00'),
      start: 1, end: '3d',
      expected: true
    },
    // Past end
    {
      value: new Date('2000-12-20T00:00:00'),
      start: -1, end: '-3d',
      expected: true
    },
    // String value
    ...
    {
      value: today,
      start: new Date('2000-12-31T00:00:00'), end: 0,
      expected: 'invalid'
    },
    {value: today, start: 0, end: '2000-12-29', expected: 'invalid'},
    {
      value: today,
      start: 0, end: new Date('2000-12-29T00:00:00'),
      expected: 'invalid'
    },
    // Today<->no limit (future)
    {
      value: new Date('2000-12-29T00:00:00'),
    ...
    // Today<->+3days
    {
      value: new Date('2001-01-03T00:00:00'),
      start: 0, end: '3d',
      expected: 'invalid'
    },
    // Today<->+1week
    {
      value: new Date('2001-01-07T00:00:00'),
      start: 0, end: '1w',
      expected: 'invalid'
    },
    // Today<->+2months
    {
      value: new Date('2000-03-01T00:00:00'),
      start: 0, end: '2m',
      expected: 'invalid'
    },
    // Today<->+2years
    {
      value: new Date('2003-12-30T00:00:00'),
      start: 0, end: '2y',
      expected: 'invalid'
    },
    // Future start
    {
      value: new Date('2000-12-30T00:00:00'),
      start: 1,
      end: undefined,
      expected: 'invalid'
    },
    {
      value: new Date('2001-01-02T00:00:00'),
      start: 1,
      end: '2d',
      expected: 'invalid'
    },
    ...
    {
      value: new Date('2000-12-27T00:00:00'),
      start: '-2d',
      end: -1,
      expected: 'invalid'
    },
